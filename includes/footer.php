            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="footer-links">
                        <h3>services</h3>
                        <ul>
                             <li><a href="cctv.php">Ai CCTV</a></li>
                            <li><a href="firealarm.php">Fire Alarm</a></li>
                            <li><a href="biometric.php">Biometric Access</a></li>
                            <li><a href="vms.php">VMS </a></li>
                            <li><a href="eas.php">EAS</a></li>
                            <li><a href="automatic.php">Automatic Fare </a></li>
                        </ul>
                    </div>
                    <!-- Footer Links End -->
                </div>
...
<!-- Mirrored from html.awaikenthemes.com/ultracam/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Jan 2026 08:17:26 GMT -->
</html>